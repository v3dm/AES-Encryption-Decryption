...
# For demo, allow all origins. Replace ["*"] with your Pages URL in production.
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
    allow_credentials=True,
...
# Import DB models / crud after creating app
from db import Base, engine
from crud import create_blob, get_blob, list_blobs, delete_blob

# Create tables on startup (safer in deployments)
